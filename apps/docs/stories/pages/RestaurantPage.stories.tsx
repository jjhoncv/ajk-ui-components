...
const Logo = () => (
  <div className="flex items-center">
    <div className="w-6">
      <img src="/images/restaurant/Logo.svg" />
    </div>
    <span className="ml-2 text-xl text-white font-extralight">Fine Dining</span>
  </div>
);
...
const LogoFooter = () => (
  <div className="flex items-center gap-2">
    <div className="w-6">
      <img src="/images/restaurant/LogoInverter.svg" />
    </div>
    <div className="ml-1 text-xl flex flex-col" style={{ lineHeight: "15px" }}>
      <p className="font-extralight text-xl text-gray-800 ">Fine Dining</p>
    </div>
  </div>
);
...
// const RestaurantLogo = ({ color = "text-white" }: { color?: string }) => (
//   <div className="flex items-center">
//     <svg
...
//       />
//     </svg>
//     <span className={`ml-2 text-xl font-bold ${color}`}>Fine Dining</span>
//   </div>
// );
