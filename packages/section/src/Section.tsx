    ...
    >
      ...
      {backgroundImage && (
        <>
          ...
          />
          {overlay && <div className={baseStyles.overlay} style={{ opacity: overlayOpacity }} />}
        </>
      )}

      {/* Container */}
      <div className={cn(baseStyles.container, containerStyles[containerWidth])}>
        <div className={cn(baseStyles.content, alignStyles[align])}>
          ...
          {/* Content */}
          <div className={cn(layoutStyles[layout], gapStyles[gap])}>{children}</div>
        </div>
      </div>
    </section>
  )
