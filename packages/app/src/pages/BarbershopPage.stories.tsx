  ...
  return (
    <ThemeProvider initialTheme={themes.barbershop.vintage}>
      <div className="min-h-screen">
        ...
        >
          <div className="flex flex-col space-y-4">
            <p className="text-gray-200">
              We take pride in providing the finest grooming services with attention to detail and
              personalized care. Our experienced barbers combine traditional techniques with modern
              styles.
            </p>
            <div>
        ...
        {/* Testimonials */}
        <Section variant="alternate" title="Client Reviews" layout="grid" gridCols={2}>
          <Card
            variant="testimonial"
