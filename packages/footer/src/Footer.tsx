...
export function Footer({
  ...
  const socialIcons = {
    facebook: (
      <svg fill="currentColor" viewBox="0 0 24 24" className={baseStyles.socialIcon}>
      ...
      <div className={baseStyles.container}>
        <div className={cn(baseStyles.content, currentVariantStyles.content)}>
          ...
          {columns && columns.length > 0 && (
            <div className={cn(baseStyles.columns, currentVariantStyles.columns)}>
          ...
          {newsletter && (
            <div className={baseStyles.newsletter}>
              ...
              <p className={baseStyles.newsletterDescription}>{newsletter.description}</p>
          ...
          {social && social.length > 0 && (
            <div className={cn(baseStyles.social, currentVariantStyles.social)}>
              {social.map((link, idx) => (
                <a key={idx} href={link.href} className="text-gray-400 hover:text-gray-300">
